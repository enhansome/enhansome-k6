...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 164 | 🐛 36 | 🌐 Go | 📅 2026-09-01 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,712 | 🐛 5,722 | 🌐 Java | 📅 2026-09-01 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-sql](https://github.com/grafana/xk6-sql) ⭐ 190 | 🐛 21 | 🌐 Go | 📅 2026-09-01 - Load-test SQL Servers (PostgreSQL, MySQL and SQLite3 for now).
* [xk6-disruptor](https://github.com/grafana/xk6-disruptor) ⚠️ Archived - Inject faults to test 💣.
* [xk6-kubernetes](https://github.com/grafana/xk6-kubernetes) ⭐ 83 | 🐛 17 | 🌐 Go | 📅 2026-09-01 - Interact with Kubernetes clusters.
* [xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) ⭐ 83 | 🐛 14 | 🌐 Go | 📅 2026-09-01 - Export results to InfluxDB v2.
* [xk6-client-tracing](https://github.com/grafana/xk6-client-tracing) ⭐ 60 | 🐛 24 | 🌐 Go | 📅 2026-08-31 - Client for load testing distributed tracing backends.
* [xk6-loki](https://github.com/grafana/xk6-loki) ⭐ 55 | 🐛 21 | 🌐 Go | 📅 2026-09-01 - Client for load testing Loki.
* [xk6-output-timescaledb](https://github.com/grafana/xk6-output-timescaledb) ⚠️ Archived - Export k6 results to TimescaleDB.
* [xk6-client-prometheus-remote](https://github.com/grafana/xk6-client-prometheus-remote) ⭐ 32 | 🐛 8 | 🌐 Go | 📅 2026-09-01 - Test Prometheus Remote Write performance.
...
* [xk6-ssh](https://github.com/grafana/xk6-ssh) ⭐ 14 | 🐛 2 | 🌐 Go | 📅 2026-09-01 - SSH.

### Community

* [xk6-kafka](https://github.com/mostafa/xk6-kafka) ⭐ 218 | 🐛 8 | 🌐 Go | 📅 2026-08-30 - Load-test Apache Kafka. Includes support for Avro messages.
* [xk6-faker](https://github.com/szkiba/xk6-faker) ⭐ 118 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-01 - Generate random fake data.
...
* [xk6-output-statsd](https://github.com/LeonAdato/xk6-output-statsd) ⭐ 35 | 🐛 9 | 🌐 Go | 📅 2026-08-31 - Enables real-time output of test metrics to a StatsD service.
...
* [xk6-kv](https://github.com/oleiade/xk6-kv) ⭐ 27 | 🐛 1 | 🌐 Go | 📅 2026-07-27 - Share key-value data between VUs.
* [xk6-output-elasticsearch](https://github.com/elastic/xk6-output-elasticsearch) ⭐ 25 | 🐛 18 | 🌐 Go | 📅 2026-08-26 - Export results to Elasticsearch 8.x.
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 6 | 🌐 Go | 📅 2026-09-01 - Export results to AWS Timestream.

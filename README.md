...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 163 | 🐛 34 | 🌐 Go | 📅 2026-08-21 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,682 | 🐛 5,718 | 🌐 Java | 📅 2026-08-21 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-sql](https://github.com/grafana/xk6-sql) ⭐ 190 | 🐛 19 | 🌐 Go | 📅 2026-08-19 - Load-test SQL Servers (PostgreSQL, MySQL and SQLite3 for now).
...
* [xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) ⭐ 83 | 🐛 12 | 🌐 Go | 📅 2026-08-20 - Export results to InfluxDB v2.
* [xk6-client-tracing](https://github.com/grafana/xk6-client-tracing) ⭐ 60 | 🐛 23 | 🌐 Go | 📅 2026-08-20 - Client for load testing distributed tracing backends.
...
* [xk6-client-prometheus-remote](https://github.com/grafana/xk6-client-prometheus-remote) ⭐ 32 | 🐛 4 | 🌐 Go | 📅 2026-08-19 - Test Prometheus Remote Write performance.
...
* [xk6-ssh](https://github.com/grafana/xk6-ssh) ⭐ 13 | 🐛 2 | 🌐 Go | 📅 2026-08-19 - SSH.
...
* [xk6-sse](https://github.com/phymbert/xk6-sse) ⭐ 52 | 🐛 12 | 🌐 Go | 📅 2026-08-18 - A k6 extension for Server-Sent Events (SSE).
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 6 | 🌐 Go | 📅 2026-08-21 - Export results to AWS Timestream.
...
* [awesome-http-benchmark](https://github.com/denji/awesome-http-benchmark) ⭐ 3,764 | 🐛 19 | 📅 2026-08-20 - A collection of HTTP benchmark tools, testing/debugging, & restAPI (RESTful).
* [Load Testing Toolkit](https://github.com/aliesbelik/load-testing-toolkit) ⭐ 252 | 🐛 1 | 📅 2026-07-01 - A collection of open-source tools for debugging, benchmarking, load and stress testing your code or services.

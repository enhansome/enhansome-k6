...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 164 | 🐛 36 | 🌐 Go | 📅 2026-08-30 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,706 | 🐛 5,717 | 🌐 Java | 📅 2026-08-28 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-client-tracing](https://github.com/grafana/xk6-client-tracing) ⭐ 60 | 🐛 24 | 🌐 Go | 📅 2026-08-28 - Client for load testing distributed tracing backends.
...
* [xk6-kafka](https://github.com/mostafa/xk6-kafka) ⭐ 218 | 🐛 9 | 🌐 Go | 📅 2026-07-18 - Load-test Apache Kafka. Includes support for Avro messages.
...
* [xk6-output-statsd](https://github.com/LeonAdato/xk6-output-statsd) ⭐ 35 | 🐛 7 | 🌐 Go | 📅 2026-08-27 - Enables real-time output of test metrics to a StatsD service.
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 5 | 🌐 Go | 📅 2026-08-30 - Export results to AWS Timestream.
...
* [awesome-http-benchmark](https://github.com/denji/awesome-http-benchmark) ⭐ 3,767 | 🐛 19 | 📅 2026-08-20 - A collection of HTTP benchmark tools, testing/debugging, & restAPI (RESTful).

...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 168 | 🐛 38 | 🌐 Go | 📅 2026-09-16 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,742 | 🐛 5,749 | 🌐 Java | 📅 2026-09-16 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-client-tracing](https://github.com/grafana/xk6-client-tracing) ⭐ 60 | 🐛 24 | 🌐 Go | 📅 2026-09-16 - Client for load testing distributed tracing backends.

...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 165 | 🐛 36 | 🌐 Go | 📅 2026-09-07 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,730 | 🐛 5,745 | 🌐 Java | 📅 2026-09-07 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-sql](https://github.com/grafana/xk6-sql) ⭐ 190 | 🐛 21 | 🌐 Go | 📅 2026-09-02 - Load-test SQL Servers (PostgreSQL, MySQL and SQLite3 for now).
...
* [xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) ⭐ 83 | 🐛 14 | 🌐 Go | 📅 2026-09-05 - Export results to InfluxDB v2.
...
* [xk6-kafka](https://github.com/mostafa/xk6-kafka) ⭐ 218 | 🐛 6 | 🌐 Go | 📅 2026-09-01 - Load-test Apache Kafka. Includes support for Avro messages.
* [xk6-faker](https://github.com/szkiba/xk6-faker) ⭐ 118 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-02 - Generate random fake data.

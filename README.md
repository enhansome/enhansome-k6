...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 164 | 🐛 36 | 🌐 Go | 📅 2026-09-02 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,715 | 🐛 5,722 | 🌐 Java | 📅 2026-09-02 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-loki](https://github.com/grafana/xk6-loki) ⭐ 55 | 🐛 21 | 🌐 Go | 📅 2026-09-02 - Client for load testing Loki.
...
* [awesome-http-benchmark](https://github.com/denji/awesome-http-benchmark) ⭐ 3,769 | 🐛 15 | 📅 2026-08-31 - A collection of HTTP benchmark tools, testing/debugging, & restAPI (RESTful).

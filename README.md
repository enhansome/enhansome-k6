...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 163 | 🐛 34 | 🌐 Go | 📅 2026-08-22 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,682 | 🐛 5,722 | 🌐 Java | 📅 2026-08-22 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) ⭐ 83 | 🐛 12 | 🌐 Go | 📅 2026-08-22 - Export results to InfluxDB v2.
* [xk6-client-tracing](https://github.com/grafana/xk6-client-tracing) ⭐ 60 | 🐛 23 | 🌐 Go | 📅 2026-08-22 - Client for load testing distributed tracing backends.
...
* [xk6-ssh](https://github.com/grafana/xk6-ssh) ⭐ 13 | 🐛 2 | 🌐 Go | 📅 2026-08-22 - SSH.

...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 168 | 🐛 38 | 🌐 Go | 📅 2026-09-15 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,740 | 🐛 5,745 | 🌐 Java | 📅 2026-09-15 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) ⭐ 83 | 🐛 15 | 🌐 Go | 📅 2026-09-15 - Export results to InfluxDB v2.
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 3 | 🌐 Go | 📅 2026-09-15 - Export results to AWS Timestream.

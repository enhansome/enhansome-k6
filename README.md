...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 168 | 🐛 39 | 🌐 Go | 📅 2026-09-17 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,746 | 🐛 5,748 | 🌐 Java | 📅 2026-09-17 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [har-to-k6](https://github.com/grafana/har-to-k6) ⭐ 164 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-14 - Tool for converting HAR recordings to k6 test scripts.
...
* [xk6-sql](https://github.com/grafana/xk6-sql) ⭐ 190 | 🐛 19 | 🌐 Go | 📅 2026-09-16 - Load-test SQL Servers (PostgreSQL, MySQL and SQLite3 for now).
* [xk6-disruptor](https://github.com/grafana/xk6-disruptor) ⚠️ Archived - Inject faults to test 💣.
* [xk6-kubernetes](https://github.com/grafana/xk6-kubernetes) ⭐ 83 | 🐛 15 | 🌐 Go | 📅 2026-09-15 - Interact with Kubernetes clusters.
* [xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) ⭐ 83 | 🐛 13 | 🌐 Go | 📅 2026-09-16 - Export results to InfluxDB v2.
* [xk6-client-tracing](https://github.com/grafana/xk6-client-tracing) ⭐ 61 | 🐛 24 | 🌐 Go | 📅 2026-09-16 - Client for load testing distributed tracing backends.
...
* [xk6-client-prometheus-remote](https://github.com/grafana/xk6-client-prometheus-remote) ⭐ 32 | 🐛 7 | 🌐 Go | 📅 2026-09-16 - Test Prometheus Remote Write performance.
...
* [xk6-ssh](https://github.com/grafana/xk6-ssh) ⭐ 14 | 🐛 2 | 🌐 Go | 📅 2026-09-16 - SSH.
...
* [xk6-faker](https://github.com/szkiba/xk6-faker) ⭐ 118 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-16 - Generate random fake data.
...
* [xk6-sse](https://github.com/phymbert/xk6-sse) ⭐ 52 | 🐛 7 | 🌐 Go | 📅 2026-09-14 - A k6 extension for Server-Sent Events (SSE).
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - Export results to AWS Timestream.

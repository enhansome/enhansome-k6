...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 166 | 🐛 36 | 🌐 Go | 📅 2026-09-10 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,737 | 🐛 5,757 | 🌐 Java | 📅 2026-09-10 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [har-to-k6](https://github.com/grafana/har-to-k6) ⭐ 164 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-09 - Tool for converting HAR recordings to k6 test scripts.
...
* [xk6-sql](https://github.com/grafana/xk6-sql) ⭐ 190 | 🐛 19 | 🌐 Go | 📅 2026-09-09 - Load-test SQL Servers (PostgreSQL, MySQL and SQLite3 for now).
* [xk6-disruptor](https://github.com/grafana/xk6-disruptor) ⚠️ Archived - Inject faults to test 💣.
* [xk6-kubernetes](https://github.com/grafana/xk6-kubernetes) ⭐ 83 | 🐛 14 | 🌐 Go | 📅 2026-09-10 - Interact with Kubernetes clusters.
* [xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) ⭐ 83 | 🐛 13 | 🌐 Go | 📅 2026-09-09 - Export results to InfluxDB v2.
* [xk6-client-tracing](https://github.com/grafana/xk6-client-tracing) ⭐ 60 | 🐛 24 | 🌐 Go | 📅 2026-09-05 - Client for load testing distributed tracing backends.
...
* [xk6-client-prometheus-remote](https://github.com/grafana/xk6-client-prometheus-remote) ⭐ 32 | 🐛 7 | 🌐 Go | 📅 2026-09-10 - Test Prometheus Remote Write performance.
...
* [xk6-ssh](https://github.com/grafana/xk6-ssh) ⭐ 14 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - SSH.
...
* [xk6-faker](https://github.com/szkiba/xk6-faker) ⭐ 118 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-09 - Generate random fake data.
...
* [xk6-sse](https://github.com/phymbert/xk6-sse) ⭐ 52 | 🐛 13 | 🌐 Go | 📅 2026-08-18 - A k6 extension for Server-Sent Events (SSE).
* [xk6-g0](https://github.com/szkiba/xk6-g0) ⭐ 47 | 🐛 8 | 🌐 Go | 📅 2026-03-01 - Write k6 tests in golang.
* [xk6-output-statsd](https://github.com/LeonAdato/xk6-output-statsd) ⭐ 36 | 🐛 9 | 🌐 Go | 📅 2026-08-31 - Enables real-time output of test metrics to a StatsD service.
* [xk6-file](https://github.com/avitalique/xk6-file) ⭐ 35 | 🐛 2 | 🌐 Go | 📅 2026-08-17 - Write files.
...
* [xk6-kv](https://github.com/oleiade/xk6-kv) ⭐ 27 | 🐛 1 | 🌐 Go | 📅 2026-09-10 - Share key-value data between VUs.
* [xk6-output-elasticsearch](https://github.com/elastic/xk6-output-elasticsearch) ⭐ 25 | 🐛 18 | 🌐 Go | 📅 2026-09-07 - Export results to Elasticsearch 8.x.
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 4 | 🌐 Go | 📅 2026-09-10 - Export results to AWS Timestream.
...
* [awesome-http-benchmark](https://github.com/denji/awesome-http-benchmark) ⭐ 3,772 | 🐛 15 | 📅 2026-08-31 - A collection of HTTP benchmark tools, testing/debugging, & restAPI (RESTful).
* [Load Testing Toolkit](https://github.com/aliesbelik/load-testing-toolkit) ⭐ 254 | 🐛 1 | 📅 2026-09-07 - A collection of open-source tools for debugging, benchmarking, load and stress testing your code or services.

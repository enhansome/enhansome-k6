...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 168 | 🐛 46 | 🌐 Go | 📅 2026-09-18 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,750 | 🐛 5,749 | 🌐 Java | 📅 2026-09-17 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-client-tracing](https://github.com/grafana/xk6-client-tracing) ⭐ 61 | 🐛 28 | 🌐 Go | 📅 2026-09-18 - Client for load testing distributed tracing backends.
...
* [xk6-sse](https://github.com/phymbert/xk6-sse) ⭐ 52 | 🐛 11 | 🌐 Go | 📅 2026-09-17 - A k6 extension for Server-Sent Events (SSE).
...
* [xk6-output-elasticsearch](https://github.com/elastic/xk6-output-elasticsearch) ⭐ 25 | 🐛 18 | 🌐 Go | 📅 2026-09-18 - Export results to Elasticsearch 8.x.
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 4 | 🌐 Go | 📅 2026-09-17 - Export results to AWS Timestream.

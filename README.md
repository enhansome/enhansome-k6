...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 167 | 🐛 37 | 🌐 Go | 📅 2026-09-11 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,738 | 🐛 5,759 | 🌐 Java | 📅 2026-09-11 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-sql](https://github.com/grafana/xk6-sql) ⭐ 190 | 🐛 20 | 🌐 Go | 📅 2026-09-11 - Load-test SQL Servers (PostgreSQL, MySQL and SQLite3 for now).
* [xk6-disruptor](https://github.com/grafana/xk6-disruptor) ⚠️ Archived - Inject faults to test 💣.
* [xk6-kubernetes](https://github.com/grafana/xk6-kubernetes) ⭐ 83 | 🐛 14 | 🌐 Go | 📅 2026-09-11 - Interact with Kubernetes clusters.
* [xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) ⭐ 83 | 🐛 14 | 🌐 Go | 📅 2026-09-11 - Export results to InfluxDB v2.
...
* [xk6-client-prometheus-remote](https://github.com/grafana/xk6-client-prometheus-remote) ⭐ 32 | 🐛 8 | 🌐 Go | 📅 2026-09-11 - Test Prometheus Remote Write performance.
...
* [xk6-ssh](https://github.com/grafana/xk6-ssh) ⭐ 14 | 🐛 3 | 🌐 Go | 📅 2026-09-11 - SSH.
...
* [xk6-faker](https://github.com/szkiba/xk6-faker) ⭐ 118 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-11 - Generate random fake data.
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 3 | 🌐 Go | 📅 2026-09-10 - Export results to AWS Timestream.
...
* [awesome-http-benchmark](https://github.com/denji/awesome-http-benchmark) ⭐ 3,772 | 🐛 15 | 📅 2026-09-11 - A collection of HTTP benchmark tools, testing/debugging, & restAPI (RESTful).

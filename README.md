...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 166 | 🐛 36 | 🌐 Go | 📅 2026-09-09 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,734 | 🐛 5,755 | 🌐 Java | 📅 2026-09-09 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-kubernetes](https://github.com/grafana/xk6-kubernetes) ⭐ 83 | 🐛 16 | 🌐 Go | 📅 2026-09-09 - Interact with Kubernetes clusters.
...
* [xk6-client-prometheus-remote](https://github.com/grafana/xk6-client-prometheus-remote) ⭐ 32 | 🐛 7 | 🌐 Go | 📅 2026-09-09 - Test Prometheus Remote Write performance.
...
* [xk6-file](https://github.com/avitalique/xk6-file) ⭐ 35 | 🐛 1 | 🌐 Go | 📅 2026-08-17 - Write files.
...
* [xk6-kv](https://github.com/oleiade/xk6-kv) ⭐ 27 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - Share key-value data between VUs.
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 6 | 🌐 Go | 📅 2026-09-07 - Export results to AWS Timestream.

...
* [k6 QuickPizza examples](https://github.com/grafana/quickpizza) ⭐ 168 | 🐛 38 | 🌐 Go | 📅 2026-09-14 - Web application used for demos and workshops with multiple k6 examples.
...
* [k6 generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,738 | 🐛 5,752 | 🌐 Java | 📅 2026-09-14 - Tool for converting Swagger/OpenAPI specifications to k6 test scripts.
...
* [xk6-sql](https://github.com/grafana/xk6-sql) ⭐ 190 | 🐛 19 | 🌐 Go | 📅 2026-09-14 - Load-test SQL Servers (PostgreSQL, MySQL and SQLite3 for now).
* [xk6-disruptor](https://github.com/grafana/xk6-disruptor) ⚠️ Archived - Inject faults to test 💣.
* [xk6-kubernetes](https://github.com/grafana/xk6-kubernetes) ⭐ 83 | 🐛 14 | 🌐 Go | 📅 2026-09-14 - Interact with Kubernetes clusters.
* [xk6-output-influxdb](https://github.com/grafana/xk6-output-influxdb) ⭐ 83 | 🐛 15 | 🌐 Go | 📅 2026-09-14 - Export results to InfluxDB v2.
...
* [xk6-output-timestream](https://github.com/leonyork/xk6-output-timestream) ⭐ 16 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - Export results to AWS Timestream.
